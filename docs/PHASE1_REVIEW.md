...
- Project scope and safety boundary
- Architecture and data flow
- STRIDE threat model
- Security requirements
- Rules of Engagement and assessment plan
- Evidence and contribution standards
- Six milestones and structured issue backlog
- Issue-driven branch, commit and Pull Request workflow
